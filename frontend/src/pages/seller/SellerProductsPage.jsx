  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editId) {
        ...
        setSuccess("Product listed in your store");
      }
      setForm(emptyForm);
      setEditId(null);
      await loadProducts();
    ...
    <div className="container page admin-page">
      <header className="page-header animate-fade-in">
        <div className="page-header__content">
          ...
          <h1 className="page-header__title">My products</h1>
          <p className="page-header__subtitle">List and manage your storefront inventory</p>
        </div>
      </header>
      ...
      <form className="admin-form" onSubmit={handleSubmit}>
        ...
        <div className="admin-form__grid">
          ...
          <p className="auth-form__hint span-2">
            Use local images from <code>/images/</code> (files in frontend/public/images/) so they work offline.
          </p>
        ...
        <div className="admin-form__actions">
          <button type="submit" className="btn btn--primary">{editId ? "Update" : "List Product"}</button>
          {editId && (
